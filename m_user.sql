...
CREATE TABLE `pajak` (
  ...
  `role` enum('ADMIN','USER','MAKER','CHECKER','APPROVER') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `m_user` (
  ...
  `role` enum('ADMIN','USER','MAKER','CHECKER','APPROVER') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2023-03-18  7:35:07
