...
import com.gateway.project.Constant.ParamConstant;
...
public class JwtTokenUtil implements Serializable {
	...
	public int getExpiredIn() {
    	Optional<MParamEntity> exp = mParamService.findByParamName(ParamConstant.JWT_EXPIRES);
    	int expires = Integer.parseInt(exp.get().getParamValue());
        return  expires;
    }

    public String getSecret() {
    	Optional<MParamEntity> str = mParamService.findByParamName(ParamConstant.JWT_KEY);
